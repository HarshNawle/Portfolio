...
const Quote = () => {
  ...
  return (
    <div className="container mx-auto max-w-4xl px-12 py-16 mt-8">
      <div className="relative px-4 py-10 border border-black/10 dark:border-white/10 rounded-xl quote-card-shadow">
